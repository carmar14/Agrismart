...
def get_variable_status(value, variable):
    ranges = {
        'temperatura': {'Malo': (float('-inf'), 15), 'Estable': (15, 20), 'Óptimo': (20, 30),
                        'Malo': (31, float('inf'))},
        'humedad_suelo': {'Malo': (float('-inf'), 50), 'Estable': (50, 60), 'Óptimo': (60, 70),
                          'Malo': (71, float('inf'))},
        'humedad_ambiente': {'Malo': (float('-inf'), 50), 'Estable': (50, 60), 'Óptimo': (60, 70),
                             'Malo': (71, float('inf'))},
        'luz': {'Malo': (float('-inf'), 2000), 'Estable': (2000, 4000), 'Óptimo': (4000, 8000),
                'Malo': (8001, float('inf'))},
        'ph_suelo': {'Malo': (float('-inf'), 5.5), 'Estable': (5.5, 6.0), 'Óptimo': (6.0, 7.0),
                     'Malo': (7.0, float('inf'))},
        'co2': {'Malo': (float('-inf'), 300), 'Estable': (300, 600), 'Óptimo': (600, 999),
                'Malo': (1000, float('inf'))},
        ...
        'potasio': {'Malo': (float('-inf'), 150), 'Estable': (150, 200), 'Óptimo': (200, 300),
                    'Malo': (301, float('inf'))}
    }
...
def predict():
    try:
        ...
        required_fields = ['temperatura', 'humedad_suelo', 'humedad_ambiente', 'luz', 'ph_suelo', 'co2', 'nitrogeno',
                           'fosforo', 'potasio']
